...
import { Grid, Button, Text, Flex, Burger } from "@mantine/core"
  ...
  return isMobile ? (
    ...
    <div style={styles.flex}>
      <Grid style={styles.grid} justify="space-around" >
        ...
        <Grid.Col style={styles.grid} span={{ base: 12, md: 6, lg: 2 }}>
          <Button variant="transparent" color="#59362a"><Link to={'/match'} style={{textDecoration: 'none', color: '#59362a'}}>Favorites</Link></Button>
